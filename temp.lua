...
local ci_mid_game_turn_timeout = 145;
local ci_late_game_turn_timeout = 190;

if test_chaos_invasion_events then
	ci_mid_game_turn_timeout = 1;
	ci_late_game_turn_timeout = 2;
end;

-- turn number to display early game event message
local ci_early_game_event_turn = 30;

-- the number of hordes we want the Chaos faction to have when spawning a new wave
-- mid game | late game
-- easy, normal, hard, very hard, legendary
local ci_max_num_hordes = {{7, 9, 9, 9, 9}, {11, 11, 11, 11, 11}};
...
function ci_setup_armies()
	...
	ram:add_mandatory_unit("chaos_1", "wh_main_chs_art_hellcannon",		                    2);
	ram:add_mandatory_unit("chaos_1", "wh_dlc06_chs_inf_aspiring_champions_0",		2);
	ram:add_mandatory_unit("chaos_1", "wh_dlc06_chs_feral_manticore",		1);
	ram:add_mandatory_unit("chaos_1", "wh_main_chs_mon_giant",		                    1);
	ram:add_mandatory_unit("chaos_1", "wh_dlc01_chs_mon_dragon_ogre_shaggoth",                    1);
	ram:add_mandatory_unit("chaos_1", "wh_dlc01_chs_cav_gorebeast_chariot",                             1);
	ram:add_mandatory_unit("chaos_1", "wh_dlc01_chs_cha_exalted_hero_10",		1);
	ram:add_mandatory_unit("chaos_1", "wh_dlc01_chs_cha_chaos_sorcerer_shadows_3",	1);

	
	ram:add_unit("chaos_1", "wh_main_chs_inf_chosen_0",			8);
	ram:add_unit("chaos_1", "wh_main_chs_inf_chosen_1",			7);
	ram:add_unit("chaos_1", "wh_dlc01_chs_inf_chosen_2",			6);
	ram:add_unit("chaos_1", "wh_main_chs_cav_chaos_knights_0",			3);
	ram:add_unit("chaos_1", "wh_main_chs_cav_chaos_knights_1",			2);
	ram:add_unit("chaos_1", "wh_dlc01_chs_mon_dragon_ogre",			1);
	ram:add_unit("chaos_1", "wh_main_chs_mon_chaos_spawn",			2);
	ram:add_unit("chaos_1", "wh_dlc01_chs_mon_trolls_1",			1);


	
	ram:new_force("chaos_2");
	
	ram:add_mandatory_unit("chaos_2", "wh_main_chs_art_hellcannon",		                    2);
	ram:add_mandatory_unit("chaos_2", "wh_dlc06_chs_inf_aspiring_champions_0",		2);
	ram:add_mandatory_unit("chaos_2", "wh_dlc06_chs_feral_manticore",		1);
	ram:add_mandatory_unit("chaos_2", "wh_main_chs_mon_giant",		                    1);
	ram:add_mandatory_unit("chaos_2", "wh_dlc01_chs_mon_dragon_ogre_shaggoth",	1);
	ram:add_mandatory_unit("chaos_2", "wh_dlc01_chs_cav_gorebeast_chariot",                             1);
	ram:add_mandatory_unit("chaos_2", "wh_dlc01_chs_cha_exalted_hero_10",		1);
	ram:add_mandatory_unit("chaos_2", "wh_main_chs_cha_chaos_sorcerer_death_11",	1);

	
	ram:add_unit("chaos_2", "wh_main_chs_inf_chosen_0",			9);
	ram:add_unit("chaos_2", "wh_main_chs_inf_chosen_1",			8);
	ram:add_unit("chaos_2", "wh_dlc01_chs_inf_chosen_2",			7);
	ram:add_unit("chaos_2", "wh_main_chs_cav_chaos_knights_0",			3);
	ram:add_unit("chaos_2", "wh_main_chs_cav_chaos_knights_1",			2);
	ram:add_unit("chaos_2", "wh_dlc01_chs_mon_dragon_ogre",			1);
	ram:add_unit("chaos_2", "wh_main_chs_mon_chaos_spawn",			2);
	ram:add_unit("chaos_2", "wh_dlc01_chs_mon_trolls_1",			1);

	ram:new_force("chaos_3");
	
	ram:add_mandatory_unit("chaos_3", "wh_main_chs_art_hellcannon",		                    2);
	ram:add_mandatory_unit("chaos_3", "wh_dlc06_chs_inf_aspiring_champions_0",		2);
	ram:add_mandatory_unit("chaos_3", "wh_dlc06_chs_feral_manticore",		1);
	ram:add_mandatory_unit("chaos_3", "wh_main_chs_mon_giant",		                    1);
	ram:add_mandatory_unit("chaos_3", "wh_dlc01_chs_mon_dragon_ogre_shaggoth",	1);
	ram:add_mandatory_unit("chaos_3", "wh_dlc01_chs_cav_gorebeast_chariot",                             1);
	ram:add_mandatory_unit("chaos_3", "wh_dlc01_chs_cha_exalted_hero_10",		1);
	ram:add_mandatory_unit("chaos_3", "wh_main_chs_cha_chaos_sorcerer_fire_11",		1);

	
	ram:add_unit("chaos_3", "wh_main_chs_inf_chosen_0",			9);
	ram:add_unit("chaos_3", "wh_main_chs_inf_chosen_1",			8);
	ram:add_unit("chaos_3", "wh_dlc01_chs_inf_chosen_2",			7);
	ram:add_unit("chaos_3", "wh_main_chs_cav_chaos_knights_0",			3);
	ram:add_unit("chaos_3", "wh_main_chs_cav_chaos_knights_1",			2);
	ram:add_unit("chaos_3", "wh_dlc01_chs_mon_dragon_ogre",			1);
	ram:add_unit("chaos_3", "wh_main_chs_mon_chaos_spawn",			2);
	ram:add_unit("chaos_3", "wh_dlc01_chs_mon_trolls_1",			1);


	ram:new_force("chaos_4");
	
	ram:add_mandatory_unit("chaos_4", "wh_main_chs_art_hellcannon",		                    2);
	ram:add_mandatory_unit("chaos_4", "wh_dlc06_chs_inf_aspiring_champions_0",		2);
	ram:add_mandatory_unit("chaos_4", "wh_dlc06_chs_feral_manticore",		1);
	ram:add_mandatory_unit("chaos_4", "wh_main_chs_mon_giant",		                    1);
	ram:add_mandatory_unit("chaos_4", "wh_dlc01_chs_mon_dragon_ogre_shaggoth",	1);
	ram:add_mandatory_unit("chaos_4", "wh_dlc01_chs_cav_gorebeast_chariot",                             1);
	ram:add_mandatory_unit("chaos_4", "wh_dlc01_chs_cha_exalted_hero_10",		1);
	ram:add_mandatory_unit("chaos_4", "wh_main_chs_cha_chaos_sorcerer_metal_11",	1);

	
	ram:add_unit("chaos_4", "wh_main_chs_inf_chosen_0",			9);
	ram:add_unit("chaos_4", "wh_main_chs_inf_chosen_1",			8);
	ram:add_unit("chaos_4", "wh_dlc01_chs_inf_chosen_2",			7);
	ram:add_unit("chaos_4", "wh_main_chs_cav_chaos_knights_0",			3);
	ram:add_unit("chaos_4", "wh_main_chs_cav_chaos_knights_1",			2);
	ram:add_unit("chaos_4", "wh_dlc01_chs_mon_dragon_ogre",			1);
	ram:add_unit("chaos_4", "wh_main_chs_mon_chaos_spawn",			2);
	ram:add_unit("chaos_4", "wh_dlc01_chs_mon_trolls_1",			1);

	
	ram:new_force("beastmen_1");
	
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_inf_cygor_0",		2);
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_mon_giant_0",		1);
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_feral_manticore",		1);
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_mon_chaos_spawn_0",		1);
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_cav_razorgor_chariot_0",		1);
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_cha_gorebull_0",		1);
	ram:add_mandatory_unit("beastmen_1", "wh_dlc03_bst_cha_bray_shaman_death_1",	1);

	ram:add_unit("beastmen_1", "wh_dlc03_bst_inf_bestigor_herd_0",			5);
	ram:add_unit("beastmen_1", "wh_dlc03_bst_inf_minotaurs_1",		                    4);
	ram:add_unit("beastmen_1", "wh_dlc03_bst_inf_minotaurs_2",		                    3);
	ram:add_unit("beastmen_1", "wh_dlc03_bst_inf_centigors_2",	                                        1);
	

	ram:new_force("beastmen_2");

	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_inf_cygor_0",		2);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_mon_giant_0",		1);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_feral_manticore",		1);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_mon_chaos_spawn_0",		2);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_inf_razorgor_herd_0",		1);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_cav_razorgor_chariot_0",		1);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_cha_gorebull_0",		1);
	ram:add_mandatory_unit("beastmen_2", "wh_dlc03_bst_cha_bray_shaman_shadows_1",	1);


	ram:add_unit("beastmen_2", "wh_dlc03_bst_inf_bestigor_herd_0",			6);
	ram:add_unit("beastmen_2", "wh_dlc03_bst_inf_minotaurs_1",		                    5);
	ram:add_unit("beastmen_2", "wh_dlc03_bst_inf_minotaurs_2",		                    4);
	ram:add_unit("beastmen_2", "wh_dlc03_bst_inf_centigors_2",	                                        2);


	ram:new_force("beastmen_3");

	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_inf_cygor_0",		2);
	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_mon_giant_0",		1);
	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_feral_manticore",		1);
	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_mon_chaos_spawn_0",		2);
	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_cav_razorgor_chariot_0",		1);
	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_cha_gorebull_0",		1);
	ram:add_mandatory_unit("beastmen_3", "wh_dlc03_bst_cha_bray_shaman_beasts_1",	1);


	ram:add_unit("beastmen_3", "wh_dlc03_bst_inf_bestigor_herd_0",			6);
	ram:add_unit("beastmen_3", "wh_dlc03_bst_inf_minotaurs_1",		                    5);
	ram:add_unit("beastmen_3", "wh_dlc03_bst_inf_minotaurs_2",		                    4);
	ram:add_unit("beastmen_3", "wh_dlc03_bst_inf_centigors_2",	                                        2);


	ram:new_force("beastmen_4");

	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_inf_cygor_0",		2);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_mon_giant_0",		1);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_feral_manticore",		1);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_mon_chaos_spawn_0",		2);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_inf_razorgor_herd_0",		1);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_cav_razorgor_chariot_0",		1);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_cha_gorebull_0",		1);
	ram:add_mandatory_unit("beastmen_4", "wh_dlc03_bst_cha_bray_shaman_wild_1",	1);


	ram:add_unit("beastmen_4", "wh_dlc03_bst_inf_bestigor_herd_0",			6);
	ram:add_unit("beastmen_4", "wh_dlc03_bst_inf_minotaurs_1",		                    5);
	ram:add_unit("beastmen_4", "wh_dlc03_bst_inf_minotaurs_2",		                    4);
	ram:add_unit("beastmen_4", "wh_dlc03_bst_inf_centigors_2",	                                        2);
...
"wh_dlc08_nor_mon_frost_wyrm_0,wh_dlc08_nor_mon_norscan_giant_0,wh_dlc08_nor_mon_fimir_0,wh_dlc08_nor_mon_fimir_1,wh_dlc08_nor_mon_war_mammoth_0,wh_dlc08_nor_mon_war_mammoth_1,wh_dlc08_nor_mon_war_mammoth_2,wh_dlc08_nor_mon_norscan_ice_trolls_0,wh_dlc08_nor_cha_fimir_balefiend_shadow_0,wh_dlc08_nor_cha_skin_wolf_werekin_0,wh_dlc08_nor_mon_skinwolves_1,wh_dlc08_nor_veh_marauder_warwolves_chariot_0,wh_dlc08_nor_mon_fimir_0,wh_dlc08_nor_mon_fimir_1,wh_dlc08_nor_inf_marauder_hunters_1,wh_dlc08_nor_inf_marauder_berserkers_0,wh_dlc08_nor_inf_marauder_champions_0,wh_dlc08_nor_inf_marauder_champions_1",

"wh_dlc08_nor_mon_norscan_giant_0,wh_dlc08_nor_mon_norscan_giant_0,wh_dlc08_nor_mon_war_mammoth_0,wh_dlc08_nor_mon_war_mammoth_1,wh_dlc08_nor_mon_war_mammoth_0,wh_dlc08_nor_mon_war_mammoth_1,wh_dlc08_nor_mon_war_mammoth_2,wh_dlc08_nor_mon_norscan_ice_trolls_0,wh_dlc08_nor_cha_fimir_balefiend_fire_0,wh_dlc08_nor_cha_skin_wolf_werekin_0,wh_dlc08_nor_mon_skinwolves_1,wh_dlc08_nor_mon_norscan_ice_trolls_0,wh_dlc08_nor_inf_marauder_berserkers_0,wh_dlc08_nor_mon_fimir_0,wh_dlc08_nor_inf_marauder_hunters_1,wh_dlc08_nor_mon_fimir_1,wh_dlc08_nor_inf_marauder_champions_0,wh_dlc08_nor_inf_marauder_champions_1",

"wh_dlc08_nor_mon_frost_wyrm_0,wh_dlc08_nor_mon_norscan_giant_0,wh_dlc08_nor_mon_fimir_0,wh_dlc08_nor_mon_fimir_1,wh_dlc08_nor_mon_war_mammoth_0,wh_dlc08_nor_mon_war_mammoth_1,wh_dlc08_nor_mon_war_mammoth_2,wh_dlc08_nor_mon_norscan_ice_trolls_0,wh_dlc08_nor_cha_shaman_sorcerer_fire_2,wh_dlc08_nor_cha_skin_wolf_werekin_0,wh_dlc08_nor_mon_skinwolves_1,wh_dlc08_nor_veh_marauder_warwolves_chariot_0,wh_dlc08_nor_mon_skinwolves_1,wh_dlc08_nor_mon_skinwolves_0,wh_dlc08_nor_inf_marauder_hunters_1,wh_dlc08_nor_inf_marauder_berserkers_0,wh_dlc08_nor_inf_marauder_champions_0,wh_dlc08_nor_inf_marauder_champions_1",

"wh_dlc08_nor_mon_frost_wyrm_0,wh_dlc08_nor_mon_norscan_giant_0,wh_dlc08_nor_mon_frost_wyrm_0,wh_dlc08_nor_veh_marauder_warwolves_chariot_0,wh_dlc08_nor_mon_war_mammoth_1,wh_dlc08_nor_mon_war_mammoth_1,wh_dlc08_nor_mon_war_mammoth_2,wh_dlc08_nor_mon_norscan_ice_trolls_0,wh_dlc08_nor_cha_shaman_sorcerer_metal_2,wh_dlc08_nor_cha_skin_wolf_werekin_0,wh_dlc08_nor_mon_skinwolves_1,wh_dlc08_nor_veh_marauder_warwolves_chariot_0,wh_dlc08_nor_inf_marauder_champions_1,wh_dlc08_nor_inf_marauder_champions_,wh_dlc08_nor_inf_marauder_hunters_1,wh_dlc08_nor_inf_marauder_berserkers_0,wh_dlc08_nor_inf_marauder_champions_0,wh_dlc08_nor_inf_marauder_champions_1"
	...
	for i = 1, num_armies_to_spawn do
		...
		while not valid do
			...
			if is_valid_spawn_point(x, y) then
				cm:create_force(
					norsca_faction_name,
					army_string[cm:random_number(4)],
					ci_chaos_home_region,
					x,
					y,
					true,
