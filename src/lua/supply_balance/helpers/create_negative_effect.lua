local function create_negative_sb_effect(faction, supply_balance)
  ...
  local additional_supply = calculate_supply_penalty(-supply_balance, num_of_armies);
  ...
  if helpers.get_game_language() == "RU" then
